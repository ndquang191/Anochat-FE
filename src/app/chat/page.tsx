...
export default function ChatPageClient({ email }: { email: string }) {
	const { messages, sendMessage, isConnected, roomId } = useSocketChat({ username: email });
	...
	// 				<div className="text-center text-muted-foreground text-lg">Đang tìm partner...</div>
	// 			</div>
	// 			<div className="mt-4">
	// 				<LogoutButton />
	// 			</div>
